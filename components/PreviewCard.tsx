...
import { User, Building2, Phone, Mail, Globe, MapPin, Award, Send, ExternalLink, Search, Linkedin, Facebook, Instagram, Twitter, Github, Youtube, Music, Mic, Video, Cake, Image as ImageIcon } from 'lucide-react';
...
export const PreviewCard: React.FC<PreviewCardProps> = ({ parsed, onShowQR, onSocialSearch, onUpdate, lang, images }) => {
  ...
  return (
    <div className="bg-white dark:bg-slate-900 rounded-xl shadow-lg border border-slate-100 dark:border-slate-800 overflow-hidden h-full flex flex-col transition-colors duration-200 relative">
      <div className="h-14 bg-gradient-to-r from-blue-600 to-indigo-600 relative shrink-0">
